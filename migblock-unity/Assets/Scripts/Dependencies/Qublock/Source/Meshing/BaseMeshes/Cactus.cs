...
public static partial class BaseMeshing {
    ...
    public static void Cactus (Chunk chunk, int x, int y, int z, MeshUVSet uvSet) {
        // if (!chunk.IsSolid(x + 1, y, z)) {
            chunk.visuVertices.Add(new Vector3(x + 0.4375f, y - 0.5f, z - 0.5f));
            chunk.visuVertices.Add(new Vector3(x + 0.4375f, y + 0.5f, z - 0.5f));
            chunk.visuVertices.Add(new Vector3(x + 0.4375f, y + 0.5f, z + 0.5f));
            chunk.visuVertices.Add(new Vector3(x + 0.4375f, y - 0.5f, z + 0.5f));
            chunk.CalculateTriangles();
            chunk.collVertices.Add(new Vector3(x + 0.4375f, y - 0.5f, z - 0.5f));
            chunk.collVertices.Add(new Vector3(x + 0.4375f, y + 0.5f, z - 0.5f));
            chunk.collVertices.Add(new Vector3(x + 0.4375f, y + 0.5f, z + 0.5f));
            chunk.collVertices.Add(new Vector3(x + 0.4375f, y - 0.5f, z + 0.5f));
        ...
        // if (!chunk.IsSolid(x, y, z + 1)) {
            chunk.visuVertices.Add(new Vector3(x + 0.5f, y - 0.5f, z + 0.4375f));
            chunk.visuVertices.Add(new Vector3(x + 0.5f, y + 0.5f, z + 0.4375f));
            chunk.visuVertices.Add(new Vector3(x - 0.5f, y + 0.5f, z + 0.4375f));
            chunk.visuVertices.Add(new Vector3(x - 0.5f, y - 0.5f, z + 0.4375f));
            chunk.CalculateTriangles();
            chunk.collVertices.Add(new Vector3(x + 0.5f, y - 0.5f, z + 0.4375f));
            chunk.collVertices.Add(new Vector3(x + 0.5f, y + 0.5f, z + 0.4375f));
            chunk.collVertices.Add(new Vector3(x - 0.5f, y + 0.5f, z + 0.4375f));
            chunk.collVertices.Add(new Vector3(x - 0.5f, y - 0.5f, z + 0.4375f));
            chunk.CalculateCollTriangles();
...
public static partial class SVBaseMeshing {
    ...
    public static void Cactus (Mesh mesh, MeshUVSet uvSet) {
