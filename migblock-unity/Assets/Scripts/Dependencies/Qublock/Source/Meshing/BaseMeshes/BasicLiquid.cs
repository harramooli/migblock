...
public static partial class BaseMeshing {
    ...
    public static void BasicLiquid (Chunk chunk, int x, int y, int z, MeshUVSet uvSet, ushort waterID, float size) {
        if (!chunk.IsId(x + 1, y, z, waterID) && !chunk.IsSolid(x + 1, y, z)) {
            ...
            chunk.fadeVertices.Add(new Vector3(x + 0.5f, y + size, z + 0.5f));
            chunk.fadeVertices.Add(new Vector3(x + 0.5f, y - 0.5f, z + 0.5f));
            chunk.CalculateFadeTriangles();
            chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.PX_X + tileSize, tileSize * uvSet.PX_Y));
        ...
        if (!chunk.IsId(x - 1, y, z, waterID) && !chunk.IsSolid(x - 1, y, z)) {
            ...
            chunk.fadeVertices.Add(new Vector3(x - 0.5f, y - 0.5f, z - 0.5f));
            chunk.CalculateFadeTriangles();
            chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.NX_X + tileSize, tileSize * uvSet.NX_Y));
        ...
        if (!chunk.IsId(x, y + 1, z, waterID)) {
            ...
            chunk.fadeVertices.Add(new Vector3(x - 0.5f, y + size, z - 0.5f));
            chunk.CalculateFadeTriangles();
            chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.PY_X + tileSize, tileSize * uvSet.PY_Y));
            chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.PY_X + tileSize, tileSize * uvSet.PY_Y + tileSize));
            chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.PY_X, tileSize * uvSet.PY_Y + tileSize));
            chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.PY_X, tileSize * uvSet.PY_Y));
                chunk.fadeVertices.Add(new Vector3(x - 0.5f, y + size, z - 0.5f));
                chunk.fadeVertices.Add(new Vector3(x + 0.5f, y + size, z - 0.5f));
                chunk.fadeVertices.Add(new Vector3(x + 0.5f, y + size, z + 0.5f));
                chunk.fadeVertices.Add(new Vector3(x - 0.5f, y + size, z + 0.5f));
                chunk.CalculateFadeTriangles();
                chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.NY_X + tileSize, tileSize * uvSet.NY_Y));
        ...
        if (!chunk.IsId(x, y, z + 1, waterID) && !chunk.IsSolid(x, y, z + 1)) {
            ...
            chunk.fadeVertices.Add(new Vector3(x - 0.5f, y - 0.5f, z + 0.5f));
            chunk.CalculateFadeTriangles();
            chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.PZ_X + tileSize, tileSize * uvSet.PZ_Y));
        ...
        if (!chunk.IsId(x, y, z - 1, waterID) && !chunk.IsSolid(x, y, z - 1)) {
            ...
            chunk.fadeVertices.Add(new Vector3(x + 0.5f, y - 0.5f, z - 0.5f));
            chunk.CalculateFadeTriangles();
            chunk.fadeUVs.Add(new Vector2(tileSize * uvSet.NZ_X + tileSize, tileSize * uvSet.NZ_Y));
...
public static partial class SVBaseMeshing {
    ...
    public static void BasicLiquid (Mesh mesh, MeshUVSet uvSet) {
