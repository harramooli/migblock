...
public static partial class BlockId {
    ...
    public const ushort WaterFlowing = 18;
}

public class WaterFlowing : BlockData {

    public override ushort Id => BlockId.WaterFlowing;

    public override string Name => "Flowing Water Block";
    ...
    public override void Draw (Chunk chunk, int x, int y, int z) {
        ...
        BaseMeshing.BasicLiquid(chunk, x, y, z, UVSet, Id, 0.5f);
    }
}
